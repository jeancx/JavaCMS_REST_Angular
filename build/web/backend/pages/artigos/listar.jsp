        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body table-responsive">
                <table class="table table-striped" id="dtTables">
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.artigos}" var="artigo">
                            <tr>
                                <td>${artigo.id}</td>
                                <td>${artigo.titulo}</td>
                                <td>${artigo.autor}</td>
                                <td>
                                    <a href="<c:out value="${url}"/>/admin/artigo/editar?id=${artigo.id}" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a>
                                    <a href="<c:out value="${url}"/>/admin/artigo/deletar?id=${artigo.id}" class="btn btn-xs btn-danger delete"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
