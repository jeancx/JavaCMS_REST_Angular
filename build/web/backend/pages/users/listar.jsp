                    ...
                    <tbody>
                        <c:forEach items="${requestScope.users}" var="user">
                            <tr>
                                ...
                                <td>${user.email}</td>
                                <td>
                                    <a href="<c:out value="${url}"/>/admin/users/editar?id=${user.id}" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a>
                                    <a href="<c:out value="${url}"/>/admin/users/deletar?id=${user.id}" class="btn btn-xs btn-danger delete"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
